...
__declspec(dllexport) HRESULT WINAPI DwmGetWindowAttribute(HWND hwnd, DWORD dwAttribute, PVOID pvAttribute,
                                                           DWORD cbAttribute) {
    LoadOmniSteamCore();
...
__declspec(dllexport) HRESULT WINAPI DwmSetWindowAttribute(HWND hwnd, DWORD dwAttribute, LPCVOID pvAttribute,
                                                           DWORD cbAttribute) {
    LoadOmniSteamCore();
...
__declspec(dllexport) BOOL WINAPI DwmDefWindowProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam,
                                                   LRESULT* plResult) {
    LoadOmniSteamCore();
